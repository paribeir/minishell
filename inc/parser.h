...
/*   Updated: 2024/10/02 14:52:15 by paribeir         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char		*process_heredoc_line(char *read_str, \
		t_token *token, t_cmd *cmd_data);
...
void		reorder_tokens(t_token *token, t_cmd_list **head, \
		t_token_subtype type, t_cmd *cmd_data);
...
int			handle_var_expansion(char *str, int *i, \
		char *new_str, t_cmd *cmd_data);
